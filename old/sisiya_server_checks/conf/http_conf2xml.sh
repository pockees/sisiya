...
do
	...
	echo "<record><system_name>$f1</system_name><isactive>t</isactive><virtual_host>$f2</virtual_host><index_file>$f3</index_file><http_port>$f4</http_port><username>$f5</username><password>$f6</password></record>"
done
echo "</systems>"
