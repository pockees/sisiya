#!/bin/bash
#
# This script is used to check IMAP connections.
#
...
if test $# -lt $min_argc || test $# -gt $max_argc ; then
	...
	echo "Example: $0 sisiya_server_checks.conf imap.example.com imap.example.com 143 10" 
	echo "Example: $0 sisiya_server_checks.conf imap.example.com imap.example.com 143 10 output_file" 
...
##########################################################################
### service id
serviceid=$serviceid_imap
if test -z "$serviceid" ; then
	echo "$0 : serviceid_imap is not defined! Exiting..."
	exit 1
fi
##########################################################################
service_name="imap"
check_prog=$sisiya_imap_check_prog
