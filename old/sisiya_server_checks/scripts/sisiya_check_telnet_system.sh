#!/bin/bash
#
# This script is used to check telnet connections.
#
...
if test $# -lt $min_argc || test $# -gt $max_argc ; then
	...
	echo "Example: $0 sisiya_server_checks.conf telnet.example.com telnet.example.com 23 10" 
	echo "Example: $0 sisiya_server_checks.conf telnet.example.com telnet.example.com 23 10 output_file" 
...
##########################################################################
### service id
serviceid=$serviceid_telnet
if test -z "$serviceid" ; then
	echo "$0 : serviceid_telnet is not defined! Exiting..."
	exit 1
fi
##########################################################################
service_name="telnet"
check_prog=$sisiya_telnet_check_prog
