...
number_of_temperature_sensors=2
tsensor_name[0]="internal"
tsensor_mib[0]=".1.3.6.1.4.1.318.1.1.1.2.2.2.0"
tsensor_error[0]=35
...
battery_mib="1.3.6.1.4.1.318.1.1.1.2.1.1.0"
str=`$check_prog -v $snmp_version $check_system -c $snmp_comm $battery_mib 2>&1`
retcode=$?
...
statusid=$status_ok  
ups_status_mib="1.3.6.1.4.1.318.1.1.1.4.1.1.0"
...
if test $retcode -eq 0 ; then
	...
	case $ups_status in
		...
		9)
			statusid=$status_error
			message_str="ERROR: The UPS is on switched bypass!"
			;;
		10)
			statusid=$status_error
			message_str="ERROR: The UPS is on hardware failure bypass!"
			;;
		11)
			statusid=$status_error
			message_str="ERROR: The UPS is sleeping until power returns!"
			;;
		12)
			statusid=$status_error
			message_str="ERROR: The UPS is on smart trim!"
			;;
		*)
			statusid=$status_error
			message_str="ERROR: The UPS status is unknown!"
...
ups_output_load_mib="1.3.6.1.4.1.318.1.1.1.4.2.3.0"
...
ups_output_voltage_mib="1.3.6.1.4.1.318.1.1.1.4.2.1.0"
...
ups_output_frequency_mib="1.3.6.1.4.1.318.1.1.1.4.2.2.0"
...
### check the output load
ups_time_on_battery_mib="1.3.6.1.4.1.318.1.1.1.2.1.2.0"
