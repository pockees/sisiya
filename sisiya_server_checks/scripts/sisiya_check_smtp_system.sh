...
if test $# -lt $min_argc || test $# -gt $max_argc ; then
	...
	echo "Usage : sisiya_server_checks.conf check_system check_system_name port expire output_file"
	echo "Example: $0 sisiya_server_checks.conf system1.example.com system1 25 10" 
	echo "Example: $0 sisiya_server_checks.conf system1.example.com system1 25 10 output_file" 
...
##########################################################################
### service id
serviceid=$serviceid_smtp
if test -z "$serviceid" ; then
	echo "$0 : serviceid_smtp is not defined! Exiting..."
	exit 1
fi
##########################################################################
service_name="smtp"
check_prog=$sisiya_smtp_check_prog
