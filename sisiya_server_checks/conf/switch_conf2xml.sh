...
do
	...
	echo "<record><system_name>$f1</system_name><isactive>t</isactive><hostname>$f2</hostname><community>$f3</community><snmp_version>$f4</snmp_version><username>$f5</username><password>$f6</password></record>"
done
echo "</systems>"
