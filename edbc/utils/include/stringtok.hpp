...
#ifndef _stringtok_header_
#define _stringtok_header_
...
*/
namespace {
	inline bool isws(char c, char const * const wstr) { return (strchr(wstr,c) != NULL); }
}
...
*/
template <typename Container>
void stringtok(Container &c,string const &s,char const * const ws = " \t\n")
{
