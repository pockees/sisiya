...
our %checks = (
		...
		'progs'	 		=> { 'auto' => 0, 'script' => 'sisiya_process_count.pl' 	},
		'raid_hpacu'	 	=> { 'auto' => 0, 'script' => 'sisiya_progs.pl' 		},
		'smart'	 		=> { 'auto' => 0, 'script' => 'sisiya_raid_hpacu.pl' 		},
		'softraid'	 	=> { 'auto' => 0, 'script' => 'sisiya_smart.pl' 		},
		'ssh_attack'	 	=> { 'auto' => 0, 'script' => 'sisiya_softraid.pl' 		},
